// fallbacks for BG images
document.addEventListener("DOMContentLoaded", function() {
  const heroSection = document.getElementById('hero');
  const bgImage = new Image();
  bgImage.src = 'images/1_hero/hero.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      heroSection.style.backgroundImage = 'radial-gradient(circle, rgb(0, 0, 0) 0%, rgb(0, 0, 0) 100%)';
  };
});

document.addEventListener("DOMContentLoaded", function() {
    const dagenhamSection = document.getElementById('dagenham');
    const bgImage = new Image();
    bgImage.src = 'images/2_dagenham/dagenham.jpg';

    bgImage.onerror = function() {
        // Replace the gradient with a fully opaque version (no transparency in the middle)
        dagenhamSection.style.backgroundImage = 'radial-gradient(circle, rgb(82, 151, 230) 0%, rgb(82, 151, 230) 100%)';
    };
});
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const bgImage = new Image();
  bgImage.src = 'images/3_beginning/beginning.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      beginningSection.style.backgroundImage = 'radial-gradient(circle, rgb(247, 231, 206) 0%, rgb(247, 231, 206) 100%)';
  };
});

document.addEventListener("DOMContentLoaded", function() {
  const unusualSection = document.getElementById('unusual');
  const bgImage = new Image();
  bgImage.src = 'images/4_unusual/unusual.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      unusualSection.style.backgroundImage = 'radial-gradient(circle, rgb(169, 169, 169) 0%, rgb(169, 169, 169) 100%)';
  };
});

document.addEventListener("DOMContentLoaded", function() {
  const barefootSection = document.getElementById('barefoot');
  const bgImage = new Image();
  bgImage.src = 'images/5_barefoot/barefoot.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      barefootSection.style.backgroundImage = 'radial-gradient(circle, rgb(227, 114, 242) 0%, rgb(227, 114, 242) 100%)';
  };
});

document.addEventListener("DOMContentLoaded", function() {
  const supplementSection = document.getElementById('supplement');
  const bgImage = new Image();
  bgImage.src = 'images/6_supplement/supplement.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      supplementSection.style.backgroundImage = 'radial-gradient(circle, rgb(211, 211, 211) 0%, rgb(211, 211, 211) 100%)';
  };
});
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const bgImage = new Image();
  bgImage.src = 'images/7_situation/situation.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      situationSection.style.backgroundImage = 'radial-gradient(circle, rgb(0, 0, 0) 0%, rgb(0, 0, 0) 100%)';
  };
});

document.addEventListener("DOMContentLoaded", function() {
  const polyglotSection = document.getElementById('polyglot');
  const bgImage = new Image();
  bgImage.src = 'images/8_polyglot/polyglot.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      polyglotSection.style.backgroundImage = 'radial-gradient(circle, rgb(173, 216, 230) 0%, rgb(173, 216, 230) 100%)';
  };
});
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const bgImage = new Image();
  bgImage.src = 'images/9_discography/discography.jpg';

  bgImage.onerror = function() {
      // Replace the gradient with a fully opaque version (no transparency in the middle)
      discographySection.style.backgroundImage = 'radial-gradient(circle, rgb(44, 77, 143) 0%, rgb(44, 77, 143) 100%)';
  };
});
